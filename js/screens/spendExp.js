game.SpendExp = me.ScreenObject.extend({
    ...
    onResetEvent: function() {
        ...
        //The keys of F1-F5 are all keys that all have a certain function
        ...
        me.game.world.addChild(new (me.Renderable.extend({
            init: function() {
                ...
                //Is the text style and color for the text
                this.font = new me.Font("Arial", 26, "white");
            },
            //Are text that appears on  the spendexp screen
        ...
        //Here the actions are connected to the F1-F5
